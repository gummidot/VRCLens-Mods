...
public class VRCLensShaderModifier
{
    ...
    public static string CopyAndModifyShader(VRCLens vrclens, string tempDir,
        bool enableLowerMinFocus, bool enableManualFocusAssist)
    {
        Shader patchedShader = VRCLensShaderPatcher.PatchShader(enableLowerMinFocus, enableManualFocusAssist);
